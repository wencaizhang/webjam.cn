...
有一个 Vue （vue2.6 版本）项目使用了 [Ant Design Vue](https://www.antdv.com/) （1.6.5版本） 作为 UI 库，其中组件[表格 Table - Ant Design Vue](https://www.antdv.com/components/table-cn#components-table-demo-row-selection-and-operation) 提供了选择行的功能。
