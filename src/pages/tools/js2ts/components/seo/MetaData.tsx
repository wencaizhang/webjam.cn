...
const SEOMetaData: FC = () => {
  return (
    <Head>
      ...
      <meta
        name='description'
        content='Generate TypeScript Interfaces from JSON, Paste JSON and Get Interface, Open-Source, Easy to use.'
      />
      ...
      <meta
        property='og:image'
        content='https://json2ts.yash.cool/twitter-large-card.jpg'
      />
    </Head>
  );
};
